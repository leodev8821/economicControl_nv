...
import { useCashes, useCreateCash, useUpdateCash, useDeleteCash } from '../hooks/useCash';
...
export const CashesPage: React.FC = () => {
  ...
  const handleCreateCash = (cashData: SharedCashSchemas.CashCreationRequest) => {
  ...
  const handleDeleteCash = (id: GridRowId) => {
    ...
    if (window.confirm(`¿Está seguro de eliminar la Caja con ID ${cashId}? Esta acción es irreversible.`)) {
