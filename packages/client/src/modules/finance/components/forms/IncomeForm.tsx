  ...
  const [form, fields] = useForm({
    onValidate({ formData }) {
      return parseWithZod(formData, {
        schema: SharedIncomeSchemas.IncomeCreationSchema,
      });
    },
      ...
      <Grid container spacing={2}>
        ...
        <Grid size={{ xs: 12, sm: 6 }}>
          <FormControl fullWidth error={!!fields.cash_id.errors}>
            ...
            {fields.cash_id.errors && (
              <FormHelperText>{fields.cash_id.errors}</FormHelperText>
            )}
            {isErrorCashes && (
              <FormHelperText error>
                Hubo un error al cargar la lista de cajas.
              </FormHelperText>
            )}
          </FormControl>
        </Grid>
        ...
        <Grid size={{ xs: 12, sm: 6 }}>
          <FormControl fullWidth error={!!fields.week_id.errors}>
            ...
            {fields.week_id.errors && (
              <FormHelperText>{fields.week_id.errors}</FormHelperText>
            )}
          </FormControl>
        </Grid>
        ...
        <Grid size={{ xs: 12, sm: 6 }}>
          <FormControl fullWidth error={!!fields.amount.errors}>
            ...
            {fields.amount.errors && (
              <FormHelperText>{fields.amount.errors}</FormHelperText>
            )}
          </FormControl>
        </Grid>
        ...
        <Grid size={{ xs: 12, sm: 6 }}>
          <FormControl fullWidth error={!!fields.source.errors}>
            ...
            {fields.source.errors && (
              <FormHelperText>{fields.source.errors}</FormHelperText>
            )}
          </FormControl>
        </Grid>
        ...
        <Grid size={{ xs: 12, sm: 6 }}>
          <FormControl fullWidth error={!!fields.person_id.errors}>
            <InputLabel id="person-select-label">
              Persona (Obligatorio para Diezmo)
            </InputLabel>
            <Select
              ...
              input={
                <OutlinedInput label="Persona (Obligatorio para Diezmo)" />
              }
              MenuProps={MenuProps}
              disabled={isFormDisabled}
            >
            ...
            {fields.person_id.errors && (
              <FormHelperText>{fields.person_id.errors}</FormHelperText>
            )}
            {isErrorPersons && (
              <FormHelperText error>
                Hubo un error al cargar la lista de personas.
              </FormHelperText>
            )}
          </FormControl>
        </Grid>
