  ...
  const [form, fields] = useForm({
    onValidate({ formData }) {
      return parseWithZod(formData, {
        schema: SharedOutcomeSchemas.OutcomeCreationSchema,
      });
    },
      ...
      <Grid container spacing={2}>
        ...
        <Grid size={{ xs: 12, sm: 6 }}>
          <FormControl fullWidth error={!!fields.description.errors}>
            <InputLabel htmlFor={fields.description.id}>
              Descripción *
            </InputLabel>
            <OutlinedInput
            ...
            {fields.description.errors && (
              <FormHelperText>{fields.description.errors}</FormHelperText>
            )}
          </FormControl>
        </Grid>
        ...
        <Grid size={{ xs: 12, sm: 6 }}>
          <FormControl fullWidth error={!!fields.category.errors}>
            ...
            {fields.category.errors && (
              <FormHelperText>{fields.category.errors}</FormHelperText>
            )}
          </FormControl>
        </Grid>
