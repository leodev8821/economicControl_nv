...
const allowedCreationRoles = [RoleType.ADMINISTRADOR, RoleType.SUPER_USER] as const;

export const UserCreationSchema = z.object({

    role: z.enum(allowedCreationRoles, {
            error: "El rol del usuario es obligatorio y debe ser ADMINISTRADOR o SUPER_USER",
        }),
    ...
    isVisible: z.boolean({
        error: "El campo de visibilidad es obligatorio",
