...
export class UserActions {
     ...
     */
    public static async getOne(data: UserSearchData): Promise<UserAttributes | null> {
     ...
     */
    public static async getOneByAnyIdentifier(identifier: string | number): Promise<UserAttributes | null> {
     ...
     */
    public static async getOneInstance(data: UserSearchData): Promise<UserModel | null> {
     ...
     */
    public static async create(data: UserCreationAttributes): Promise<UserAttributes> {
     ...
     */
    public static async update(id: number, data: Partial<UserCreationAttributes>): Promise<UserAttributes | null> {
