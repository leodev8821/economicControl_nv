...
export class WeekActions {
     ...
     */
    public static async getOne(data: WeekSearchData): Promise<WeekAttributes | null> {
    ...
    public static async generateWeeksForYear(year: number): Promise<WeekAttributes[]> {
        ...
        try {
            ...
            const newWeeks = await WeekModel.bulkCreate(weeksToCreate, { ignoreDuplicates: true });
